...
import MissingItemMessageDetails from './MissingItemMessage.component';
import {
    COMPLAIN_CONFIRM,
    CONFIRM_POPUP_ID
...
class MissingItemMessage extends PureComponent {
    static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(MissingItemMessage);