...
import ExchangeFromStorePopup from './ExchangeFromStorePopup.component';
import { CONFIRM_POPUP_ID } from './ExchangeFromStorePopup.config';

export const mapStateToProps = (state) => ({
    payload: state.PopupReducer.popupPayload[CONFIRM_POPUP_ID] || {}
});
...
export class ExchangeFromStorePopupContainer extends PureComponent {
    static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ExchangeFromStorePopupContainer);
