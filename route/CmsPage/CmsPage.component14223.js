...
export class CmsPage extends PureComponent {
            ...
            <>
                ...
                <div className="message-banner">
                    <div className="message-banner-content">
                        ...
                        <h1>{this.state.loyaltyPoints !== ""  ? this.state.loyaltyPoints  : <Skeleton variant="rectangular" width="30px" height="13px" padding="12px" />}</h1>
            ...
            <div className="message-banner">
                    <div className="message-banner-content">
                        ...
                        <div style={{ display: 'flex', justifyContent: 'center' }}>
                            ...
                            <div className="bottom-content">
                                <div className="tooltip">?
                                    <span className="tooltiptext fa fa-question"></span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    renderContent() {
        ...
        console.log("areeb khan",content1)
        ...
        if(params?.identifier === "home" || CategoryType === "women-new" || CategoryType === "men-new" ){
        return (<>
    ...
    async loyaltypoints (){
        ...
        const tokenData = JSON.parse(localStorage.getItem("auth_token"))
            if (tokenData !== null) {
                ...
                loyaltyPoints = result.data.getCustomeLoyaltyPoints
                
                console.log(loyaltyPoints, "<----loyaltyPoints above")
                ...
                if(loyaltyPoints === null){
                    ...
                    console.log(loyaltyPoints.pointsAvailable, "<---pointsAvailable")
                    this.setState({
                        loyaltyPoints: parseInt(loyaltyPoints.pointsAvailable) ,
                       })
                }
            }
    }
    ...
    async componentDidUpdate() {
        ...
        await Promise.allSettled([promise1, promise2, promise4, promise5]).then((result) => {
            console.log('promiseResult...', result);
           
            content1Result1 = result[0]?.value
            content1Result2 = result[1]?.value
            // loyaltyPoints = result[2]?.value || {}
            weatherResponse = result[2]?.value || {}
            seggmentsData = result[3]?.value || {}
        })
        ...
        if (tokenData !== null && this.state.count === 0) {
            ...
            if( Object.keys(weatherResponse).length   === 0  || Object.keys(seggmentsData).length  === 0){
