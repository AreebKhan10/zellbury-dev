...
export const MenNew = lazy(() => import(/* webpackMode: "lazy", webpackChunkName: "cms" */ 'Route/MenNew'));
export const WomenNew = lazy(() => import(/* webpackMode: "lazy", webpackChunkName: "cms" */ 'Route/WomenNew'));
// export const CmsPageWomen = lazy(() => import(/* webpackMode: "lazy", webpackChunkName: "cms" */ 'Route/CmsPageWomen'));
...
export class Router extends PureComponent {
    ...
    [SWITCH_ITEMS_TYPE] = [
        ...
        {
            component: <Route path={ withStoreRegex('/men-new') } exact component={ MenNew } />,
            position: 11
        },
        {
            component: <Route path={ withStoreRegex('/women-new') } exact component={ WomenNew } />,
            position: 12
        },
