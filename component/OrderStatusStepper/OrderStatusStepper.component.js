        ...
        return (
            <div block="Checkout" elem="Step">
                <div className="stapper-vertical-container">
                    ...
                    {(!TrackingDetail && order.base_order_info.status_label != 'Shipped' || TrackingDetail.length==0 && order.base_order_info.status_label != 'Shipped' || order.base_order_info.status_label.toLowerCase()==='packed' || order.base_order_info.status_label.toLowerCase()==='confirmed') &&  <h4 className="orderDeliverySec">Once the order is shipped <br /> we will update your tracking information here.</h4>}
                    ...
                    {(!TrackingDetail && order.base_order_info.status_label === 'Shipped' || TrackingDetail.length==0 && order.base_order_info.status_label === 'Shipped' || order.base_order_info.status_label === 'Shipped') &&  <h4 className="orderDeliverySec">Your order is shipped <br /> we will update your tracking information here.</h4>}
                </div>
            </div>
        );
    }
