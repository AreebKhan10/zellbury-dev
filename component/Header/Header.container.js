...
export class HeaderContainer extends NavigationAbstractContainer {
    ...
    routeMap = {
        ...
        '/cart': { name: CART },
        '/menu': { name: MENU },
        '/page': { name: CMS_PAGE, onBackClick: () => history.push('/') },
        '/ordercomplain/orderslist': { name: ORDER_COMPLAIN, title: __('Complain form'), onBackClick: () => history.push('/') },
        '/ordercomplain/active-orders/order-detail': { name: ORDER_PAGE_DETAIL, onBackClick: () => history.push('/ordercomplain/orderslist') },
        '/ordercomplain/qrcode': { name: ORDER_SCAN, title: __('Scan the Price tag'), onBackClick: () => history.push('/ordercomplain/orderslist') },
        '/ordercomplain/delivered-orders/store-list': { name: STORES_LIST, title: __('Stores List'), onBackClick: () => history.push('/ordercomplain/delivered-orders/exchange-order') },
        '/ordercomplain/delivered-orders/exchange-order': { name: EXCHANGE_OPTION, onBackClick: () => history.push('/ordercomplain/qrcode') },
        '/ordercomplain/delivered-orders/overcharged-issue': { name: OVERCHARGED_PAGE, onBackClick: () => history.push('/ordercomplain/orderslist') },
        '/ordercomplain/delivered-orders/fabric-light-thick': { name: FABRIC_PAGE, title: __('Fabric Page'), onBackClick: () => history.push('/ordercomplain/orderslist') },
    ...
    handleHeaderVisibility() {
        ...
        const category = localStorage.getItem("PageType")
    ...
    async onShareButtonClick(e) {
        const { navigationState: { title } } = this.props;
        // const { navigationState: { onShareClick } } = this.props;
        //this.setState({ searchCriteria: '' });
        // if (onShareClick) {
        //     onShareClick(e);
        // }
