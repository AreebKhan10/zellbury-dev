 ...
 */
 ...
 import './DeliveredOrderOptions.style';
 ...
 export class DeliveredOrderOptions extends PureComponent {
     static propTypes = {
     ...
     render() {
         const { isLoading, deliveredOrderOptions, handleSubOptionChange } = this.props;
         ...
         return (
             <>
                ...
                {deliveredOrderOptions.map((item) => {
                   return (
 ...
 export default DeliveredOrderOptions;